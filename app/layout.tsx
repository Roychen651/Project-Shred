...
import { Rubik, Heebo, IBM_Plex_Sans_Hebrew } from "next/font/google";
...
// lib/theme/tokens.ts for why.
//
// Sprint 16: display face switched from Frank Ruhl Libre (a serif) to Rubik —
// a geometric, rounded, heavy-weight Hebrew-native sans, the same register the
// reference apps use for big bold numerals/headings. See tokens.ts's
// FONT_DISPLAY comment for the full reasoning.
const rubik = Rubik({
...
export default function RootLayout({
  ...
  return (
    <html
      lang="he"
      dir="rtl"
      className={`h-full antialiased ${rubik.variable} ${heebo.variable} ${ibmPlexSansHebrew.variable}`}
    >
